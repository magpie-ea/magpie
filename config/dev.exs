...
config :magpie, MagpieWeb.Endpoint,
  ...
  # Changed to `ip: {0, 0, 0, 0}` to allow access from other machines (e.g. in docker-compose env).
  http: [ip: {0, 0, 0, 0}, port: 4000],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "uQ8ka4gLwHLnzGUOD02dJRK8mDvLp3QWAD1HJ41KU/cOlIkvisb/RV+LYAN/K0Bu",
  watchers: [
